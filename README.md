...
```bash
pnpm add @mutual-processadora-de-pagamentos/lib-http-kit
```
...
```typescript
import { ExpressAdapter } from "@mutual-processadora-de-pagamentos/lib-http-kit";
...
import {
  ...
  type ReqBody,
  type Res,
} from "@mutual-processadora-de-pagamentos/lib-http-kit";
import { z } from "zod";
...
```typescript
import { route } from "@mutual-processadora-de-pagamentos/lib-http-kit";
import { z } from "zod";
...
```typescript
import { authorize } from "@mutual-processadora-de-pagamentos/lib-http-kit";
...
```typescript
import { InternalOnly } from "@mutual-processadora-de-pagamentos/lib-http-kit";
...
```typescript
import { PermissionManager } from "@mutual-processadora-de-pagamentos/lib-http-kit";
...
```typescript
import { PermissionUtils } from "@mutual-processadora-de-pagamentos/lib-http-kit";
...
```typescript
import { createFlatPermissionSchema } from "@mutual-processadora-de-pagamentos/lib-http-kit";
import { z } from "zod";
...
```typescript
import { applyDomainValidation } from "@mutual-processadora-de-pagamentos/lib-http-kit";
import { z } from "zod";
...
UNLICENSED — Uso privado pela Mutual Processadora de Pagamentos.
